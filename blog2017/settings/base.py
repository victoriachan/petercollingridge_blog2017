...
DATABASES = {
    "default": dj_database_url.config(
        conn_max_age=600, default="postgres:///blog2017"
    )
}
...
if "SENTRY_DSN" in env:
    ...
    # dokku config:set blog2017 SENTRY_ENVIRONMENT=staging
...
WAGTAILADMIN_RICH_TEXT_EDITORS = {
    "default": {
        ...
        "OPTIONS": {"features": ["bold", "italic", "h3", "h4", "ol", "ul", "link", "strikethrough"]},
    }
}
